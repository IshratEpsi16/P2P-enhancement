...
const supplierBasicModel = require("../../../../models/api/v1/supplierRegistrationBasic");
const commonObject = require("../../../../common/api/v1/common");
const fileUploaderCommonObject = require("../../../../common/api/v1/fileUploader");

const verifyToken = require("../../../../middleware/jwtValidation");

router.get("/existing-details", [verifyToken], async (req, res) => {
...
router.get(`/item-list`, verifyToken, async (req, res) => {
  try {
    let value = {
...
router.get(`/organization-type-list`, verifyToken, async (req, res) => {
  try {
    let value = {
        message: `Organization Type List`,
        status: 200,
        data: []
      };
  
      let userQueryResult = await supplierBasicModel.organizationTypeList();
      await commonObject.makeArrayObject(userQueryResult);
      value.data = userQueryResult.queryResult.finalData;
      return res.status(200).json(value);
