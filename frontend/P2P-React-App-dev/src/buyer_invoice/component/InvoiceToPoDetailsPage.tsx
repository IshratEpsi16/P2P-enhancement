...
import ShipmentAcceptRejectService from "../../shipment_receive/service/ShipmentAcceptRejectService";
...
import ShipmentListPoService from "../../shipment_receive/service/ShipmentListPoService";
...
export default function InvoiceToPoDetailsPage() {
  //context
  ...
  const getSinglePo = async () => {
    ...
    try {
      const result = await ShipmentListPoService(
        token!,
        selectedInvoice?.PO_HEADER_ID!,
        1,
        10
      ...
      if (result.data && result.data.data.length > 0) {
        ...
        console.log("single po details", result.data.data);
  ...
  const [isAcceptRejectModalOpen, setIsAcceptRejectModalOpen] =
  ...
  const handleStatusChange = async (
    ...
    console.log(
      `Shipment ID: ${shipmentId}, po: ${shipmentPoNo}, org: ${shipmentOrg} Status: ${status}`
    );
  ...
  const handleModalSubmit = async () => {
    if (isNoteMandatory && note.trim() === "") {
      ...
      try {
        console.log(
          `Shipment ID: ${selectedShipmentId}, Status: ${selectStatus}, Note: ${note}`
        );

        const result = await ShipmentAcceptRejectService(
          token!,
          selectedShipmentId!,
          selectedPoNumber!,
          selectedOrgId!,
        ...
        <>
          ...
          <div className=" grayCard p-4 w-full flex items-start justify-between mb-8">
            ...
            <div className=" flex-1 space-y-2">
              ...
              <div className=" w-full flex space-x-2">
                ...
                <p className=" text-midBlack font-mon font-medium text-sm ">
                  {!singlePoDetails[0]?.SUPPLIER_ORGANIZATION_NAME
                    ? "---"
                    : singlePoDetails[0].SUPPLIER_ORGANIZATION_NAME}
                </p>
              </div>
            ...
            <div className=" flex-1 space-y-2">
              ...
              <div className=" w-full flex space-x-2">
                ...
                <p className=" text-midBlack font-mon font-medium text-sm ">
                  {!singlePoDetails[0]?.RFQ_DETAILS.CS_ID
                    ? "---"
                    : singlePoDetails[0]?.RFQ_DETAILS.CS_ID}
                </p>
              </div>
            ...
            <div className=" flex-1 space-y-2">
              ...
              <div className=" w-full flex space-x-2">
                ...
                <p className=" text-midBlack font-mon font-medium text-sm ">
                  {!singlePoDetails[0]?.TOTAL_PO_AMOUNT
                    ? "---"
                    : singlePoDetails[0].TOTAL_PO_AMOUNT}
                </p>
              </div>
          ...
          <div className="grayCard p-4 w-full flex items-start justify-between mb-8">
            ...
            <div className=" flex-1 space-y-2">
              ...
              <div className=" w-full flex">
                ...
                <p className=" text-midBlack font-mon font-medium text-sm w-44">
                  {!singlePoDetails[0]?.RFQ_DETAILS
                    .BUYER_ATTACHMENT_FILE_NAME ? (
                    "---"
                  ) : (
                    <a
                      target="_blank"
                      href={`${poTermFilePathInBuyerInvoice}/${singlePoDetails[0]?.RFQ_DETAILS.BUYER_ATTACHMENT_FILE_NAME}`}
              ...
              <div className=" w-full flex">
                ...
                <p className=" text-midBlack font-mon font-medium text-sm w-44">
                  {moment(singlePoDetails[0]?.RFQ_DETAILS.ETR).format(
                    "DD-MMMM-YYYY"
                  )}
                </p>
              </div>
                ...
                <p className=" text-midBlack font-mon font-medium text-sm w-44">
                  <div
                    className={`h-4 w-4 rounded-md border-[1px] border-borderColor flex justify-center items-center ${
                      singlePoDetails[0]?.RFQ_DETAILS.VAT_APPLICABLE_STATUS ===
                      "Y"
                        ? "bg-midGreen"
                        : "bg-white"
                    }`}
            ...
            <div className=" flex-1 space-y-2">
              ...
              <div className=" w-full flex">
                ...
                <p className=" text-midBlack font-mon font-medium text-sm w-44">
                  {!singlePoDetails[0] ? (
                    ...
                    <a
                      href={`${poTermFilePathInBuyerInvoice}/${singlePoDetails[0].SUP_TERM_FILE}`}
                      className=" smallViewButton"
                    >
                      view
                    </a>
              ...
              <div className=" w-full flex space-x-12">
                ...
                <p className=" text-midBlack font-mon font-medium text-sm w-full">
                  ...
                  {!singlePoDetails[0]?.SUPPLIER_NOTE
                    ? "---"
                    : singlePoDetails[0]?.SUPPLIER_NOTE}
                </p>
              </div>
          ...
          <dialog id="my_modal_3" className="modal">
            <div className="modal-box w-11/12 max-w-5xl">
              ...
              <p className="py-4">
                {singlePoDetails[0]?.RFQ_DETAILS.BUYER_GENERAL_TERMS}
              </p>
            </div>
          ...
          {isAcceptRejectModalOpen && (
            <div className="fixed inset-0 flex justify-center items-center z-50 bg-opacity-50 bg-gray-700">
              <div className="w-[400px] h-[300px] relative bg-white rounded-[10px]">
                ...
                <div
                  className={`w-full flex justify-end items-end px-8 top-[195px] absolute text-sm ${
