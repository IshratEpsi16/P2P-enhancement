...
import BankListViewForApprovalService from "../../service/bank/BankListViewForApprovalService";
...
import BankDetailsViewForApprovalService from "../../service/bank/BankDetailsViewForApprovalService";
...
export default function BankDetailsViewForApprovalPage() {
  ...
  const {
    ...
    supplierCountryCode,
    isRegCompelte,
  } = useAuth(); //basic info te set korte hbe
  ...
  }, [bankDetails, bankFromOracleList, currencyListFromOracle]);
