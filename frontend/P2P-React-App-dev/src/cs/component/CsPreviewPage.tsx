...
const pan = ["Home", "RFQ List", "RFQ Item List", "CS Creation", "CS Preview"];

export default function CsPreviewPage() {
  ...
  const submit = async () => {
    // nextPage();
    console.log(convertedItemsForCsCreationAndUpdateInStore?.length);
  ...
  useEffect(() => {
    console.log("general term: ", csGeneralTermInStore);
  }, []);
  ...
  useEffect(() => {
    console.log(quotationDataListInStore);
  }, []);

  const [saveLoading, setSaveLoading] = useState(false);

  useEffect(() => {
    console.log("cs: ", quotationDataListInStore);
  ...
  const save = async () => {
    try {
      ...
      console.log(rfqHeaderDetailsInStore?.details.CONVERSION_RATE);
  ...
  //     s +=
  //       (parseFloat(itemList[i].AWARD_QUANTITY) || 0) * //OFFERED_QUANTITY sili award korlam
                            ...
                            {prHistory.map((e, i) => (
                              <div className=" space-y-1 ">
                                ...
                                >
                                  ...
                                  <p className=" text-sm font-mon font-medium text-blackColor w-56 py-2 whitespace-normal px-2">
                                    {!e.ITEM_SPECIFICATION
                                      ? "N/A"
                                      : e.ITEM_SPECIFICATION}
                                  </p>
                                </div>
                                {/* <div className="w-56 py-2 flex justify-center items-center bg-green-100  whitespace-normal px-2 ">
                                  {!e.ITEM_SPECIFICATION
                                    ? "N/A"
                                    : e.ITEM_SPECIFICATION}
                                </div> */}
      ...
      <div className="modal">
        <div className="modal-box relative w-3/4 overflow-x-hidden max-w-7xl flex flex-col justify-center items-center">
          ...
          <div className=" w-full  flex items-end justify-end font-mon text-sm">
            {csGeneralTermInStore!.length}/4000
          </div>
