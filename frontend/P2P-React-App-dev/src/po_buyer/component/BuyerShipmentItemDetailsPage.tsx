...
export default function BuyerShipmentItemDetailsPage() {

  const [isLoading, setIsLoading] = useState<boolean>(false);
  const [shipmentItemDetails, setShipmentItemDetails] = useState<ShipmentItemDetailsInterface[]>([]);

  const { shipmentIdInStore, setShipmentIdInStore, grnNumberInStore, poNumberInStore, poHeaderInStore, setPoNumberInStore } = useSupplierPoStore();
