...
import ContactDetailsViewForApprovalService from "../../manage_supplier/service/contact/ContactDetailsViewForApprovalService";
...
export default function RfiContactDetailsApprovalViewPage() {
