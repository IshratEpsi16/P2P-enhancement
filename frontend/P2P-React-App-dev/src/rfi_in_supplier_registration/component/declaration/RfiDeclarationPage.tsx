...
import DeclarationViewForApprovalService from "../../../manage_supplier/service/declaration/DeclarationViewForApprovalService";
...
export default function RfiDeclarationPage() {
