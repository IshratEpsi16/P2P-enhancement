...
import CsCreateUpdateService from "../../cs/service/CsCreateUpdateService";
...
export default function ApproveCsPreviewPage() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < itemList.length; i++) {
      s +=
        (parseFloat(itemList[i].OFFERED_QUANTITY) || 0) *
      ...
      <div className=" flex flex-row justify-end space-x-6">
        ...
        {saveLoading ? (
          ...
          <CommonButton
            ...
            titleText={savedCsIdInStore == null ? "Save CS" : "Update CS"}
            width="w-48"
            height="h-8"
          />
        )}
        ...
        <div className="modal-box relative w-3/4 overflow-x-hidden max-w-7xl flex flex-col justify-center items-center">
          ...
          {supplierListInStore?.map((e, i) => (
            ...
            <p className=" pl-4 text-sm text-blackColor font-mon pr-4 py-2 ${
              i === 0 ? "border-t-[0.2px] border-b-[0.2px]" : "border-b-[0.2px]"
            }
            `}
                >
